  ...
  const accordionData = [
    {
      ...
      image:
        "/smarthometechnologywallsystemandcouplewith20231127051651utc-1@2x.png",
      content: {
        text: "IT Service Management (ITSM)",
        deliverResilientITServices:
          "Deliver resilient IT services and create experiences that help your teams be more productive. Resolve issues quickly and speed the pace of innovation using AI and machine learning.",
        unburdenYourITServicesStaff:
          "Unburden your IT services staff and boost IT productivity",
        createResilientAdaptablePeople1:
          "Create resilient & adaptable people first experiences",
        deliverITServicesOnASingle1:
          "Deliver IT services on a single system of engagement by using workflows to synthesise your shared data and analytics",
      },
    },
    {
      id: 2,
      ...
      content: {
        ...
        deliverResilientITServices:
          "Gain visibility into your multistack IT environment, on-premises to cloud, and see the impact on your applications and business services. Predict issues and automate resolutions assisted by generative AI.",
        unburdenYourITServicesStaff:
          "Gain full visibility into your infrastructure, including on-premises, cloud, and serverless environments. Manage TLS certificates and firewall policies on a single platform",
        createResilientAdaptablePeople1:
          "Analyze telemetry and log data using generative AI to reduce noise, predict issues, and automate resolution",
        deliverITServicesOnASingle1:
          "Accelerate Cloud Adoption by automated service workflows and continuous governance",
    ...
    },
    {
      ...
      content: {
        ...
        deliverResilientITServices:
          "Take your customer service to the next level while controlling operating costs. Resolve issues quickly and delight customers with AI-powered self-service. Set your agents up for success with real-time information to boost their productivity.",
        unburdenYourITServicesStaff:
          "Provide self-service across multiple communication channels (e.g., social media to AI-powered virtual agents)",
        createResilientAdaptablePeople1:
          "Enhanced cross-department collaboration",
        deliverITServicesOnASingle1:
          "Provide real-time insights for agents with GenAI infused tools to quickly resolve customer requests",
        cta: "Contact Us for ServiceNow Consultation",
      },
    },
    {
      ...
      content: {
        ...
        unburdenYourITServicesStaff:
          "Automate ITAM by doing it where you plan, service, and operate IT—on one platform, one data model, and one architecture",
        createResilientAdaptablePeople1:
          "Realise Savings throughout the asset lifecycle by optimizing software licenses, tracking hardware assets, and managing cloud resources",
        deliverITServicesOnASingle1:
    ...
    },
    {
      ...
      content: {
        ...
        deliverResilientITServices:
          "Improve productivity by making it easy for employees to get the help and guidance they need, all in one place. Reduce costs with AI-driven self-service and streamlined case resolution.",
        unburdenYourITServicesStaff:
          "Deliver intelligent customised (region/local) self-service experiences to reduce case volumes and help employees get results faster",
        createResilientAdaptablePeople1:
          "Provide embedded experiences across any digital channel, e.g. ServiceNow in Teams",
        deliverITServicesOnASingle1:
          "Improve employee service experience of remote workers to maintain productivity",
        cta: "Contact Us for ServiceNow Consultation",
      },
    },
    {
      ...
      content: {
        ...
        unburdenYourITServicesStaff:
          "Reach operational agility by using MITRE ATT&CK to investigate threats and close gaps",
        createResilientAdaptablePeople1:
          "Prioritize remediation by applying risk-based vulnerability management across your infrastructure and collaborative workspaces for effective management and remediation",
        deliverITServicesOnASingle1:
          "Know your security posture by viewing key metrics and indicators with role-based dashboards and reporting",
        cta: "Contact Us for ServiceNow Consultation",
      },
    },
    {
      ...
      content: {
        text: "Now Assist",
        deliverResilientITServices:
          "Out-of-the-box Gen AI that helps employees, customers, agents, and developers work smarter.",
        unburdenYourITServicesStaff:
          "Case Summarisation reduces manual work for agents and operators with overviews and insights",
        createResilientAdaptablePeople1:
          "Enriched Virtual Agent conversations by deflecting cases, empowering people, and delivering engaging, dynamic experiences with natural human language",
        deliverITServicesOnASingle1:
          "Generate content automatically, including knowledge articles, emails, chats, intelligent search results, and work notes",
        cta: "Contact Us for ServiceNow Consultation",
      },
    },
  ];
  ...
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal]">
      ...
      <div className="self-stretch flex flex-row items-start justify-start max-w-full w-full">
        <div
          className="max-w-[1536px] mx-auto w-full px-[4.375rem] py-[2rem]
          mq1325:px-[2rem] 
          mq800:px-[1rem]
          mq450:px-[0.5rem]"
        >
          <div
            className="font-archivo text-[1.125rem] text-color-6 leading-[2rem] max-w-[58rem]
            mq1050:max-w-full mq400:text-[1rem] mq900:p-[0.5rem]"
          >
            The following are the implementation services we can deliver to help
            you realise your strategic goals. They also set the foundation to
            approach custom automated workflows, e.g. loan operations, claims
            management, etc.
          </div>
        </div>
      </div>
              ...
              >
                  ...
                  <div
                    className={`w-[21.063rem] font-medium font-archivo text-[1.5rem] bg-[transparent] relative leading-[3.125rem] ${
                      openAccordion === item.id
                        ? "text-color-5"
                        : "text-color-6"
                    } text-left inline-block p-0 z-[10] mq520:text-[1.188rem] mq520:leading-[2.5rem] whitespace-nowrap mq400:text-[1rem] mq400:whitespace-normal mq400:leading-[2.5rem]`}
                  >
                    {item.title}
                  </div>
                  <motion.div
                ...
                <AnimatePresence mode="wait">
                  {openAccordion === item.id && (
                    ...
                    >
                      <div
                        className="w-full flex flex-row items-start justify-between gap-[2rem] mt-[1rem]
