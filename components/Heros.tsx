...
const Heros: NextPage<HerosType> = ({
  ...
  return (
    <section
      className={`w-screen flex flex-row items-start justify-start pt-[0rem] px-[0rem] pb-[4.5rem] box-border text-left text-[3.375rem] text-white font-archivo mq800:pb-[2.938rem] mq800:box-border ${className}`}
    ...
    >
      <div className="w-full flex flex-row items-start justify-start relative">
        ...
        <div className="absolute w-full h-full top-0 left-0 flex items-end">
          <div className="max-w-[1536px] w-full mx-auto px-[4.375rem] pb-[4.875rem] mq800:px-[1.5rem]">
